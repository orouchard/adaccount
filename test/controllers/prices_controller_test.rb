...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference("Price.count") do
      post prices_url, params: { price: { active: @price.active, amount: @price.amount, currency: @price.currency, date_from: @price.date_from, date_to: @price.date_to, product_id: @price.product_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { active: @price.active, amount: @price.amount, currency: @price.currency, date_from: @price.date_from, date_to: @price.date_to, product_id: @price.product_id } }
