...
class ParamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create param" do
    assert_difference("Param.count") do
      post params_url, params: { param: { active: @param.active, group: @param.group, label: @param.label, value: @param.value } }
    end
  ...
  test "should update param" do
    patch param_url(@param), params: { param: { active: @param.active, group: @param.group, label: @param.label, value: @param.value } }
