...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference("Period.count") do
      post periods_url, params: { period: { active: @period.active, date_from: @period.date_from, date_to: @period.date_to, name: @period.name } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { active: @period.active, date_from: @period.date_from, date_to: @period.date_to, name: @period.name } }
