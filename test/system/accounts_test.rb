...
class AccountsTest < ApplicationSystemTestCase
  ...
  test "should create account" do
    ...
    fill_in "Group", with: @account.group
    fill_in "Increases", with: @account.increases
    fill_in "Statement", with: @account.statement
    fill_in "Subgroup", with: @account.subgroup
