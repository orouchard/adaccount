class PricesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @price.product, notice: "Price was successfully destroyed." }
  ...
  private
    ...
    def price_params
      params.require(:price).permit(:product_id, :date_from, :date_to, :amount, :currency, :active)
    end
end
